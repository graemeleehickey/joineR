...
Add points to an existing plot of an object of class `jointdata`, for a
longitudinal variable. It is possible plot all the subjects in the data
set, or just a selected `subset`. See
...
are useful to be used with this as
