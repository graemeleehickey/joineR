...
#' effects joint model as represented by \code{object} of class \code{cjoint}.
#'
#' @param object an object of class \code{cjoint}.
...
#'
#' @author Pete Philipson (\email{pete.philipson@@northmbria.ac.uk}) and Graeme
#'   L. Hickey (\email{graeme.hickey@liverpool.ac.uk})
#' @keywords methods
#'
#' @return An object inheriting from class \code{summary.cjoint} with all
#'   components included in \code{object} (see \code{\link{cjoint}} for a full
...
#'   individual subjects.}
#' @export
summary.cjoint <- function(object, variance = TRUE, ...) {
