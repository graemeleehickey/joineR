...
#' (r_ij-r_ik)^2$$ and the corresponding time differences $$u_ijk=t_ij-t_ik$$.
#' The variogram is plotted for averages of each time lag for the $v_ijk$ for
#' all $i$
#' 
...
#' @return The function returns a list with two elements. The first \code{svar}
#' is a matrix with columns for all values $(u_ijk,v_ijk)$, and the second
#' \code{sigma2} is the total variability in the data. This is an object of
#' class \code{vargm}
