...
This vignette demonstrates how to fit a joint model for longitudinal data and
competing risks outcomes using `joineR`. It replicates the analysis of
Williamson et al. (2008) applied to the SANAD epilepsy trial data.
...
also note that currently only 2 failure types can be modelled, which must be
...
6. Williamson PR, Kolamunnage-Dona R, Tudur Smith C. The influence of competing
